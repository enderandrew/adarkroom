...
const GAME_GLOBALS = {
	...
	Temple: 'readonly', Crater: 'readonly', Hazard: 'readonly', Builder: 'readonly', Swamp: 'readonly', Village: 'readonly', Prison: 'readonly', Achievements: 'readonly', MobileUI: 'readonly', Maze: 'readonly', Lab: 'readonly', Swipe: 'readonly', EasterEggs: 'readonly', Graveyard: 'readonly',
