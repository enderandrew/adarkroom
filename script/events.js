...
var Events = {
	...
	winFight: function() {
		Engine.setTimeout(function() {
			...
			Events.endFight();
			/* If this fight was a maze encounter (an 'X' tile in a dungeon
			 * generated by Maze), applies its deferred "cleared" mark now
			 * that the win is confirmed. A no-op for every other fight --
			 * see Maze.checkTrigger() and Maze.confirmPendingClear(). */
			if (typeof Maze !== 'undefined') {
				Maze.confirmPendingClear();
			}
